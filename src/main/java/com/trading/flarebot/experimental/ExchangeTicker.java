...
import com.trading.flarebot.unifiedtradingview.config.SupportedExchange;
...
public class ExchangeTicker implements Runnable {
    ...
    public void run() {
        ...
        UnifiedTradingViewClient unifiedTradingViewClient = ExchangeClientFactory.getUnifiedTradingViewClient(clientMetadata);
